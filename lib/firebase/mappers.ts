import type { Customer, Order, PaymentAgent, PaymentAgentLedgerEntry, Product, Supplier } from "@/lib/types";
...
export const paymentAgentLedgerEntryFromFirestore = (doc: unknown): PaymentAgentLedgerEntry => {
  ...
  return {
    ...
    amount: asNum(e.amount) ?? 0, creditUsed: asNum(e.creditUsed), payableAfterCredit: asNum(e.payableAfterCredit), paidNow: asNum(e.paidNow), remainingPayable: asNum(e.remainingPayable), newCreditCreated: asNum(e.newCreditCreated), dueReduced: asNum(e.dueReduced), creditCreated: asNum(e.creditCreated), resultingCreditBalance: asNum(e.resultingCreditBalance), note: asStr(e.note) || undefined, createdAt: asStr(e.createdAt, now), paymentDate: asStr(e.paymentDate) || undefined, reversalOfId: asStr(e.reversalOfId) || undefined
  };
};
export const paymentAgentLedgerEntryToFirestore = (entity: PaymentAgentLedgerEntry): Record<string, unknown> => ({ ...entity, sourceOrderId: entity.sourceOrderId ?? null, sourceOrderNumber: entity.sourceOrderNumber ?? null, creditUsed: entity.creditUsed ?? null, payableAfterCredit: entity.payableAfterCredit ?? null, paidNow: entity.paidNow ?? null, remainingPayable: entity.remainingPayable ?? null, newCreditCreated: entity.newCreditCreated ?? null, dueReduced: entity.dueReduced ?? null, creditCreated: entity.creditCreated ?? null, resultingCreditBalance: entity.resultingCreditBalance ?? null, note: entity.note ?? null, paymentDate: entity.paymentDate ?? null, reversalOfId: entity.reversalOfId ?? null });
...
export const orderFromFirestore = (doc: unknown): Order => {
  ...
  return { ...(o as any), id: asStr(o.id), number: asStr(o.number) || asStr(o.orderNumber), orderNumber: asStr(o.orderNumber) || asStr(o.number), date: asStr(o.date), wechatId: asStr(o.wechatId), status: (asStr(o.status) as Order["status"]) || "draft", paymentBy: asStr(o.paymentBy), paymentAgentId: asStr(o.paymentAgentId), paidToPaymentAgentNow: asNum(o.paidToPaymentAgentNow) ?? 0, lines: lines as any, createdAt: asStr(o.createdAt, now), updatedAt: asStr(o.updatedAt, now), savedAt: asStr(o.savedAt) || undefined, draftAutosavedAt: asStr(o.draftAutosavedAt) || undefined, lastEditedAt: asStr(o.lastEditedAt) || undefined } as Order;
};

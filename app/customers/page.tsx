...
import { logDB, logError, logRoute, logUI } from "@/lib/logger";
...
export default function CustomersPage() {
  ...
  const { data: customers, error, recordPaymentToCustomer, reload } = useCustomers();
      ...
      <div className="space-y-4 p-6">
        <div className="flex items-center justify-between">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-6 flex-1">
            ...
            <StatCard label="Total Spent" value={formatAmount(base.reduce((s, c) => s + c.totalSpent, 0))} />
            <StatCard label="Outstanding Amount" value={formatAmount(base.reduce((s, c) => s + (c.outstandingAmount ?? 0), 0))} />
          </div>

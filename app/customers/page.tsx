      ...
      <div className="space-y-4 p-6">
        <div className="flex items-center justify-between">
          ...
          <div className="ml-3 flex gap-2">
            ...
            {firebaseMode ? <Button onClick={async () => { try { await customerLedgerService.repairCustomerLedgerFromSavedOrders(); await reload(); pushToast({ tone: "success", text: "Customer ledger repaired from saved orders." }); } catch (e) { pushToast({ tone: "danger", text: e instanceof Error ? e.message : "Could not repair customer ledger." }); } }} variant="secondary"><Plus size={14} />Repair Customer Ledger From Saved Orders</Button> : null}

...
export function OrderLineRow({ line, onChange, onRemove, onUploadingChange, supplierSuggestions = [], customerSuggestions = [] }: Props) {
  ...
  return (
    ...
    >
      ...
      <Input compact value={line.customerId} onChange={(e) => onChange({ customerId: e.target.value })} placeholder="Customer name" list={`customer-list-${line.id}`} />

...
export function OrderForm({ draft, setDraft, onUploadingChange, onRemoveLine, wechatSuggestions = [], supplierSuggestions = [], customerSuggestions = [], customers = [], paymentAgents = [] }: Props) {

...
export function OrderForm({ draft, setDraft, onUploadingChange, onRemoveLine, wechatSuggestions = [], supplierSuggestions = [], customerSuggestions = [], customers = [], paymentAgents = [], showOrderInfo = true }: Props) {

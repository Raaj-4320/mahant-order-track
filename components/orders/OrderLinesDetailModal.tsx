          ...
          <div className="overflow-x-auto rounded-lg border border-border">
            <table className="w-full min-w-[1050px] text-[12px]">
              <thead className="bg-bg-subtle text-left uppercase tracking-wide text-fg-subtle">
                <tr>
                  <th className="px-3 py-2">Dimension Photo</th><th className="px-3 py-2">Product Photo</th><th className="px-3 py-2">Marka</th><th className="px-3 py-2">Details</th><th className="px-3 py-2">Total Cartons</th><th className="px-3 py-2">PCS / Carton</th><th className="px-3 py-2">Rate / PCS</th><th className="px-3 py-2">Line Total</th><th className="px-3 py-2">Customer</th>
                </tr>
              </thead>
              <tbody>

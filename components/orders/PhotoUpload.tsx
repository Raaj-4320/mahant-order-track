      ...
      >
        {(isUploading && (localPreviewUrl || value)) ? (
          ...
          <>
            ...
            {onPreview ? <button type="button" title="Open image preview" aria-label="Open image preview" className="absolute inset-0 cursor-zoom-in" onClick={(e) => { e.stopPropagation(); onPreview(value); }} /> : null}
            <button
              type="button"
              onClick={(e) => {
                e.stopPropagation();

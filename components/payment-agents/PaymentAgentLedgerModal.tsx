...
export function PaymentAgentLedgerModal({ open, summary, entries, orders, customers, error, onClose, onExport, onAddPayment }: Props) {
  ...
  const kpis = [
    { label: "Total Advanced", value: formatAmount(accounting.totalAdvanced), tone: "text-sky-700 bg-sky-50 border-sky-100", icon: <Wallet size={16} /> },
    { label: "Total Used", value: formatAmount(accounting.totalUsed), tone: "text-slate-700 bg-slate-50 border-slate-200", icon: <Download size={16} /> },

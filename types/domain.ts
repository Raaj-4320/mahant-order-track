...
export type PaymentAgent = { id: string; agentCode: string; name: string; initials: string; phone: string; wechatId: string; country: string; city?: string; status: EntityStatus; totalOrdersPaid: number; totalPaidAmount: number; createdAt: string; updatedAt: string; notes?: string; defaultCurrency?: string; paymentMethods?: string[]; creditBalance?: number; openingCredit?: number; totalUsedAmount?: number; currentPayable?: number; currency?: string; };
...
export type Order = { id: string; orderNumber: string; number: string; date: string; loadingDate?: string; paymentAgentId: string; paymentBy: string; paymentAgentSnapshot?: EntitySnapshot; wechatId: string; status: OrderStatus; paymentStatus: PaymentStatus; supplierSummary?: string; customerSummary?: string; totalUniqueItems?: number; subtotal?: number; discount?: number; tax?: number; grandTotal?: number; paidAmount?: number; dueAmount?: number; paidToPaymentAgentNow?: number; lines: OrderLine[]; notes?: string; createdAt?: string; updatedAt?: string; };

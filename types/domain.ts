...
export type OrderLine = { id: string; supplierId: string; supplierName?: string; supplierSnapshot?: EntitySnapshot; picDim: string; productId: string; productSnapshot?: EntitySnapshot; marka: string; details?: string; detail1?: string; detail2?: string; detail3?: string; totalCtns: number; pcsPerCtn: number; rmbPerPcs: number; customerRate?: string; loadingDate?: string; customerId: string; customerName?: string; customerSnapshot?: EntitySnapshot; photoUrl?: string; productPhotoUrl?: string; notes?: string; sortOrder?: number; };

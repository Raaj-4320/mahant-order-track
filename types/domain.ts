...
export type Product = { id: string; productCode: string; sku: string; name: string; marka: string; category: string; unit: string; defaultDim?: string; photo: string; supplierId?: string; supplierSnapshot?: EntitySnapshot; purchasePrice?: number; sellingPrice?: number; defaultRmbPerPcs?: number; stockQty?: number; lowStockLimit?: number; status: EntityStatus; createdAt: string; updatedAt: string; };

...
export type Order = { id: string; orderNumber: string; number: string; orderPrefix?: string; orderSequenceNumber?: number; date: string; loadingDate?: string; paymentAgentId: string; paymentBy: string; paymentByName?: string; paymentAgentName?: string; paymentAgentSnapshot?: EntitySnapshot; wechatId: string; status: OrderStatus; paymentStatus: PaymentStatus; supplierSummary?: string; customerSummary?: string; totalUniqueItems?: number; subtotal?: number; discount?: number; tax?: number; grandTotal?: number; paidAmount?: number; dueAmount?: number; paidToPaymentAgentNow?: number; paymentAgentSettlementSnapshot?: { orderTotal: number; existingCredit: number; creditUsed: number; payableAfterCredit: number; remainingPayable: number; newCreditCreated: number; resultingCreditBalance: number; paidNow: number; status: "unpaid" | "partial" | "paid" | "credit"; paymentAgentId?: string; paymentAgentName?: string; createdAt?: string; updatedAt?: string }; lines: OrderLine[]; notes?: string; createdAt?: string; updatedAt?: string; savedAt?: string; draftAutosavedAt?: string; lastEditedAt?: string; lifecycle?: LifecycleMetadata; dependencyMap?: OrderDependencyMap; };
